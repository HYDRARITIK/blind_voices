...
class TestPico2(unittest.TestCase):

    @patch('pico2.network.WLAN')
    ...
    def test_send_data_to_server_success(self, mock_socket):
        ...
        pico2.send_data_to_server(mock_s, "data")
